...
(*   Updated: 2015/06/26 19:47:13 by lguarda          ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
class sexithiophene =
    object
        inherit Molecule.molecule "sexithiophene" ((grp_atom new Atom_sub_class.hydrogen 14)
        @(grp_atom new Atom_sub_class.carbon 24)@(grp_atom new Atom_sub_class.soufre 6))
    end

class lucifer_yellow =
    object
        inherit Molecule.molecule "lucifer_yellow" ((grp_atom new Atom_sub_class.hydrogen 9)
        @(grp_atom new Atom_sub_class.oxygen 9)@(grp_atom new Atom_sub_class.azote 5)
        @(grp_atom new Atom_sub_class.carbon 13)@(grp_atom new Atom_sub_class.soufre 2)
        @(grp_atom new Atom_sub_class.litium 2))
    end
